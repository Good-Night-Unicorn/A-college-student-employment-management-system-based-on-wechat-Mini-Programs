...
public class ZhaopinxinxiVO  implements Serializable {
	...
	public void setJinengtiaojian(String jinengtiaojian) {
		this.jinengtiaojian = jinengtiaojian;
	}
	
	/**
	 * 获取：技能条件
	 */
	public String getJinengtiaojian() {
		return jinengtiaojian;
	}
