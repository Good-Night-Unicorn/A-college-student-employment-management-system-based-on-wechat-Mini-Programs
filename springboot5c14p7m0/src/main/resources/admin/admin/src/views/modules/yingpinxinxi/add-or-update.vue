	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="upload" v-if="type!='info'&& !ro.jianlitoudi" label="简历投递" prop="jianlitoudi" >
					<file-upload
						tip="点击上传简历投递"
						action="file/upload"
						:limit="1"
				...
				<el-form-item v-else-if="ruleForm.jianlitoudi" label="简历投递" prop="jianlitoudi" >
					<el-button class="downBtn" type="text" size="small" @click="download($base.url+ruleForm.jianlitoudi)">
			...
			<el-form-item class="textarea" v-if="type!='info'" label="应聘说明" prop="yingpinshuoming" >
				<el-input
					style="min-width: 200px; max-width: 600px;"
					type="textarea"
					:rows="8"
					placeholder="应聘说明"
					v-model="ruleForm.yingpinshuoming" >
				</el-input>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.yingpinshuoming" label="应聘说明" prop="yingpinshuoming" >
				<span class="text">{{ruleForm.yingpinshuoming}}</span>
			</el-form-item>
		...
		data() {
			...
			return {
				...
				rules: {
					...
					yingpinshuoming: [
						{ required: true, message: '应聘说明不能为空', trigger: 'blur' },
					],
					toudishijian: [
					],
					xuehao: [
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='yingpinshuoming'){
							this.ruleForm.yingpinshuoming = obj[o];
							this.ro.yingpinshuoming = true;
							continue;
						}
						if(o=='toudishijian'){
