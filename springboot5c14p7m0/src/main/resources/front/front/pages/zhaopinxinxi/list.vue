			...
			<view :style='{"minHeight":"100%","padding":"0 20rpx","flexWrap":"wrap","background":"#E9E9E9","display":"flex","width":"100%","position":"relative","height":"auto"}'>
				<view class="cu-bar bg-white search" :style='{"padding":"20rpx 0 0 0","margin":"0","background":"none","display":"flex","width":"100%","position":"relative","height":"auto","order":"1"}'>
					<view :style='{"border":"2rpx solid #3d4e81","margin":"0","borderRadius":"20rpx","flex":"1","background":"#fff","lineHeight":"80rpx","position":"relative","height":"80rpx"}' class="search-form round">
						...
						<input placeholder-style="color: #333" :style='{"border":"0","padding":"12rpx 20rpx 12rpx 80rpx","color":"#333","borderRadius":"40rpx","background":"none","width":"100%","lineHeight":"80rpx","fontSize":"28rpx","height":"80rpx"}' v-model="searchForm.gangweimingcheng" type="text" placeholder="岗位名称" ></input>
					</view>
				...
				<view :style='{"width":"100%","flexWrap":"wrap","background":"none","display":"flex","height":"auto","order":"5"}'>
					<scroll-view scroll-x="true" class="category-one" :style='{"padding":"0","margin":"20rpx 0","whiteSpace":"nowrap","borderRadius":"20rpx","background":"none","flexDirection":"row","display":"flex","width":"100%","height":"auto"}'>
						<view :class='categoryName === item.gangweileixing ? "active" : ""' class="tab" v-for="(item,index) in categoryList" :key="index" @tap="categoryClick(item.gangweileixing)">{{item.gangweileixing}}</view>
					</scroll-view>
					<!-- 样式2 -->
					<view class="list" :style='{"width":"100%","padding":"0","margin":"0","borderRadius":"20rpx","background":"none","height":"auto"}'>
						<view @tap="onDetailTap(product)" class="listm flex flex-between" :style='{"boxShadow":"0 2rpx 12rpx rgba(0,0,0,.3)","padding":"20rpx","margin":"0 0 20rpx","borderRadius":"20rpx","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","height":"auto"}' v-for="(product,index) in list" :key="index">
							...
							<view class="listmr" :style='{"width":"calc(100% - 200rpx)","padding":"0","margin":"0","height":"auto"}'>
								<view class="col3 f30 elip mb15" :style='{"padding":"0 20rpx","margin":"0","overflow":"hidden","color":"#333","width":"100%","lineHeight":"48rpx","fontSize":"28rpx"}'>{{product.gangweimingcheng}}</view>
								<view class="col3 f30 elip mb15" :style='{"padding":"0 20rpx","margin":"0","overflow":"hidden","color":"#333","width":"100%","lineHeight":"48rpx","fontSize":"28rpx"}'>{{product.gangweileixing}}</view>
								<view class="col3 f30 elip mb15" :style='{"padding":"0 20rpx","margin":"0","overflow":"hidden","color":"#333","width":"100%","lineHeight":"48rpx","fontSize":"28rpx"}'>{{product.gongzidaiyu}}</view>
								<view class="col3 f30 elip mb15" :style='{"padding":"0 20rpx","margin":"0","overflow":"hidden","color":"#333","width":"100%","lineHeight":"48rpx","fontSize":"28rpx"}'>{{product.wuxianyijin}}</view>
								...
								<view :style='{"padding":"0 20rpx"}'>
									...
									<text :style='{"color":"#666","lineHeight":"1.5","fontSize":"24rpx"}'>{{product.qiyemingcheng}}</text>
								</view>
							...
							<view :style='{"width":"100%","padding":"8rpx 20rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
								<view :style='{"display":"flex"}' v-if="(userid && isAuth('zhaopinxinxi','修改')) || (!userid && isAuthFront('zhaopinxinxi','修改'))" @tap.stop.proevent="onUpdate" :data-row="product">
								...
								<view :style='{"display":"flex"}' v-if="(userid && isAuth('zhaopinxinxi','删除')) || (!userid && isAuthFront('zhaopinxinxi','删除'))" @tap.stop.proevent="onDelete" :data-row="product">
							...
							<!-- #ifndef MP-WEIXIN -->
							<view :style='{"width":"100%","padding":"8rpx 20rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
								<view :style='{"display":"flex"}' v-if="(userid && isAuth('zhaopinxinxi','修改')) || (!userid && isAuthFront('zhaopinxinxi','修改'))" @tap.stop.proevent="onUpdateTap(product)">
									<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#666","display":"inline-block"}' class="cuIcon-edit"></text>
									<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"#666","display":"inline-block"}'>修改</text>
								</view>
								<view :style='{"display":"flex"}' v-if="(userid && isAuth('zhaopinxinxi','删除')) || (!userid && isAuthFront('zhaopinxinxi','删除'))" @tap.stop.proevent="onDeleteTap(product.id)">
									<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#666","display":"inline-block"}' class="cuIcon-delete"></text>
									<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"#666","display":"inline-block"}'>删除</text>
								</view>
							</view>
				...
				<button :style='{"border":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,.3)","margin":"20rpx ","color":"rgb(255, 255, 255)","outline":"none","borderRadius":"20rpx","background":"linear-gradient(45deg, #3d4e81, #5753c9, #6e7ff3)","width":"120rpx","lineHeight":"70rpx","fontSize":"28rpx","position":"relative","height":"70rpx","zIndex":"1","order":"3"}' v-if="userid && isAuth('zhaopinxinxi','新增')" class="add-btn" @click="onAddTap()">新增</button>
				<button :style='{"border":"0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,.3)","margin":"20rpx ","color":"rgb(255, 255, 255)","outline":"none","borderRadius":"20rpx","background":"linear-gradient(45deg, #3d4e81, #5753c9, #6e7ff3)","width":"120rpx","lineHeight":"70rpx","fontSize":"28rpx","position":"relative","height":"70rpx","zIndex":"1","order":"3"}' v-if="!userid && isAuthFront('zhaopinxinxi','新增')" class="add-btn" @click="onAddTap()">新增</button>
				...
				<view class="screenBox" :class="screenBoxShow?'screenBoxActive':''">
					<view :style='{"width":"100%","padding":"20rpx 0 20rpx 0","alignItems":"center","flexWrap":"wrap","justifyContent":"space-around","display":"flex"}'>
						<view :style='{"width":"100%","padding":"0 0 0 20rpx","fontSize":"24rpx"}'>职位</view>
						<input :style='{"border":"2rpx solid rgb(162, 144, 104)","padding":"0 20rpx 0 20rpx","borderRadius":"40rpx","background":"none","width":"90%","fontSize":"24rpx","height":"80rpx"}' placeholder="请输入职位" v-model="searchForm.zhiwei">
					</view>
					<view :style='{"width":"100%","padding":"20rpx 0 20rpx 0","alignItems":"center","flexWrap":"wrap","justifyContent":"space-around","display":"flex"}'>
						<view :style='{"width":"100%","padding":"0 0 0 20rpx","fontSize":"24rpx"}'>工资待遇</view>
						<input :style='{"border":"2rpx solid rgb(162, 144, 104)","padding":"0 20rpx 0 20rpx","borderRadius":"40rpx","background":"none","width":"90%","fontSize":"24rpx","height":"80rpx"}' placeholder="请输入工资待遇" v-model="searchForm.gongzidaiyu">
					</view>
					<view :style='{"width":"100%","padding":"20rpx 0 20rpx 0"}'>
						<view :style='{"width":"100%","padding":"0 0 20rpx 20rpx","fontSize":"24rpx"}'>五险一金</view>
						<view :style='{"width":"100%","flexWrap":"wrap","justifyContent":"space-around","display":"flex"}'>
							<view @click="wuxianyijinChange(item)" v-for="(item,index) in wuxianyijinOptions" :key="index" class="screenTab" :class="searchForm.wuxianyijin==item?'screenTabActive':''">{{item}}</view>
						</view>
					</view>
					<view :style='{"width":"100%","padding":"20rpx 0 20rpx 0","alignItems":"center","flexWrap":"wrap","justifyContent":"space-around","display":"flex"}'>
						<view :style='{"width":"100%","padding":"0 0 0 20rpx","fontSize":"24rpx"}'>学历要求</view>
						<input :style='{"border":"2rpx solid rgb(162, 144, 104)","padding":"0 20rpx 0 20rpx","borderRadius":"40rpx","background":"none","width":"90%","fontSize":"24rpx","height":"80rpx"}' placeholder="请输入学历要求" v-model="searchForm.xueliyaoqiu">
					</view>
					<view :style='{"width":"100%","padding":"20rpx 0 20rpx 0","alignItems":"center","flexWrap":"wrap","justifyContent":"space-around","display":"flex"}'>
						<view :style='{"width":"100%","padding":"0 0 0 20rpx","fontSize":"24rpx"}'>专业要求</view>
						<input :style='{"border":"2rpx solid rgb(162, 144, 104)","padding":"0 20rpx 0 20rpx","borderRadius":"40rpx","background":"none","width":"90%","fontSize":"24rpx","height":"80rpx"}' placeholder="请输入专业要求" v-model="searchForm.zhuanyeyaoqiu">
					</view>
					<view :style='{"width":"100%","padding":"20rpx 0 20rpx 0","alignItems":"center","flexWrap":"wrap","justifyContent":"space-around","display":"flex"}'>
						<view :style='{"width":"100%","padding":"0 0 0 20rpx","fontSize":"24rpx"}'>技能条件</view>
						<input :style='{"border":"2rpx solid rgb(162, 144, 104)","padding":"0 20rpx 0 20rpx","borderRadius":"40rpx","background":"none","width":"90%","fontSize":"24rpx","height":"80rpx"}' placeholder="请输入技能条件" v-model="searchForm.jinengtiaojian">
					</view>
...
<script>
	export default {
		...
		async onShow() {
            ...
            let res = {};
            if(this.userid) {
                res = await this.$api.page('gangweileixing', {page:1,limit:100});
            } else {
                res = await this.$api.list('gangweileixing', {page:1,limit:100});
            }
			res.data.list.splice(0,0,{id:0,gangweileixing:'全部'})
		...
		methods: {
			...
			async upCallback(mescroll) {
				...
				if(this.categoryName!='全部'){
					params.gangweileixing = '%' + this.categoryName + '%'
				}
				...
				if(this.searchForm.gongzidaiyu){
					params['gongzidaiyu'] = '%' + this.searchForm.gongzidaiyu + '%'
				}
				if(this.searchForm.wuxianyijin){
					params['wuxianyijin'] = '%' + this.searchForm.wuxianyijin + '%'
				}
				if(this.searchForm.xueliyaoqiu){
					params['xueliyaoqiu'] = '%' + this.searchForm.xueliyaoqiu + '%'
				}
				if(this.searchForm.zhuanyeyaoqiu){
					params['zhuanyeyaoqiu'] = '%' + this.searchForm.zhuanyeyaoqiu + '%'
				}
				if(this.searchForm.jinengtiaojian){
					params['jinengtiaojian'] = '%' + this.searchForm.jinengtiaojian + '%'
				}
				let user = uni.getStorageSync("appUserid")?JSON.parse(uni.getStorageSync('userSession')):{}
                let res = {}
                if(this.userid) {
                    res = await this.$api.page(`zhaopinxinxi`, params);
                } else {
                    res = await this.$api.list(`zhaopinxinxi`, params);
                }
			...
			async search(){
				...
				if(this.categoryName!='全部'){
					searchForm.gangweileixing = '%' + this.categoryName + '%'
				}
				if(this.searchForm.zhiwei){
					searchForm['zhiwei'] = '%' + this.searchForm.zhiwei + '%'
				}
				if(this.searchForm.gongzidaiyu){
					searchForm['gongzidaiyu'] = '%' + this.searchForm.gongzidaiyu + '%'
				}
				if(this.searchForm.wuxianyijin){
					searchForm['wuxianyijin'] = '%' + this.searchForm.wuxianyijin + '%'
				}
				if(this.searchForm.xueliyaoqiu){
					searchForm['xueliyaoqiu'] = '%' + this.searchForm.xueliyaoqiu + '%'
				}
				if(this.searchForm.zhuanyeyaoqiu){
					searchForm['zhuanyeyaoqiu'] = '%' + this.searchForm.zhuanyeyaoqiu + '%'
				}
				if(this.searchForm.jinengtiaojian){
					searchForm['jinengtiaojian'] = '%' + this.searchForm.jinengtiaojian + '%'
				}
                let res = {};
                if(this.userid) {
                    res = await this.$api.page(`zhaopinxinxi`, searchForm);
                } else {
                    res = await this.$api.list(`zhaopinxinxi`, searchForm);
                }
				// 如果是第一页数据置空
